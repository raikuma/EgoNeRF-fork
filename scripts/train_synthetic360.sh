python train.py --config configs/EgoNeRF/synthetic/archiviz-flat_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/barbershop_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/classroom_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/fisher-hut_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/lone_monk_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/pavilion-midday-pond_n/default.txt;
...
python train.py --config configs/EgoNeRF/synthetic/restroom_n/default.txt;
